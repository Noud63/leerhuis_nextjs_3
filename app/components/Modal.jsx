...
const Modal = ({currentImage, nextImage, prevImage, closeModal, index}) => {
      ...
      <div className="mx-4 flex items-center flex-col absolute">
        ...
        <div className="relative">
          <Image
            ...
            width={800}
            height={0}
            className="w-[800px] h-auto shadow-[0px_4px_28px_rgba(0,0,0,0.5)] border-2 border-[#d7e2df] rounded-lg"
            onClick={closeModal}
          />
        </div>
        ...
        <div className="w-full max-w-[800px] h-[60px] flex justify-center bottom-30 right-[50%]">
          ...
          <div className="w-11 p-2 cursor-pointer rounded-full flex justify-center text-white mx-1 mt-4 border-2 shadow-[0px_4px_28px_rgba(0,0,0,0.5)]">{index + 1}</div>
          <div
